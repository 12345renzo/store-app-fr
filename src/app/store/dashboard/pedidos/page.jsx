...
import AdminPediView from "@/view/AdminPediView";
import SearchFecha from "@/view/SearchFecha";
        ...
        <Container maxWidth="xl">
          ...
          >
            <Grid2
              ...
              m="15px 0"
            >
              <SearchFecha initialQuery={searchQuery}/>
            </Grid2>
          </Grid2>
        </Container>
        <AdminPediView buscar={searchQuery}/>
      </AuthRedirect>
    </>
  );
}
